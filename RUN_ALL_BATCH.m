...
% Options: Run classification on volume-based data and/or on surface-based data
surfaceClass = 1; % 1: ON / 0: OFF
volumeClass = 0; % 1: ON / 0: OFF
...
run_all_sub_main_analysis(1,classifier);
...
%   4. Compute betas with GLM: computeGLM.m
%   5. Classification for every subject with and without permutation of labels.
run_all_sub_main_analysis(2,classifier);
